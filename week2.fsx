...
let data = DelimitedReader.Read<double>("/Users/carsten/Projects/FsLab.Templates-journal/ex1data1.txt", false, ",", false);
...
let J_vals = [for i in theta0_vals -> [for j in theta1_vals -> computeCost X y (vector [float i; float j]) ]]
